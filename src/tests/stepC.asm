...
foo_integer_tail_rec_begin:
	...
	move $a3, $t6
	jr $ra
infiniteNotTailRec_integer_integer_integer:
	sw $fp, 0($sp)
	sw $ra, -4($sp)
infiniteNotTailRec_integer_integer_integer_tail_rec_begin:
	move $fp, $sp
	subi $sp, $sp, 24
	move $t0, $a2
	sw $t0, 0($sp)
	...
	move $a1, $t1
	move $a2, $t2
	jal infiniteNotTailRec_integer_integer_integer
	subi $sp, $sp, 0
	sw $v0, 0($sp)
	lw $t1, 0($sp)
	addi $t0, $t1, 1
	...
	move $a3, $t6
	jr $ra
infiniteTailRec_integer_integer_integer:
	sw $fp, 0($sp)
	sw $ra, -4($sp)
infiniteTailRec_integer_integer_integer_tail_rec_begin:
	move $fp, $sp
	subi $sp, $sp, 24
	move $sp, $fp
	addi $sp, $sp, -24
	...
	sw $t5, -16($sp)
	sw $t6, -20($sp)
	jal infiniteTailRec_integer_integer_integer_tail_rec_begin
	li $v0, 0
	move $sp, $fp
	lw $t1, 0($fp)
	lw $t2, -4($fp)
...
main_integer_tail_rec_begin:
	...
	move $a0, $t0
	move $a1, $t1
	jal tailRecFact_integer_integer
	subi $sp, $sp, 0
	sw $v0, 0($sp)
	lw $t0, 0($sp)
	la $t1, h
...
retBis_tail_rec_begin:
	...
	move $a3, $t6
	jr $ra
tailRecFactBisBisBis_integer_integer_integer_integer_integer_integer_integer:
	sw $fp, 0($sp)
	sw $ra, -4($sp)
tailRecFactBisBisBis_integer_integer_integer_integer_integer_integer_integer_tail_rec_begin:
	move $fp, $sp
	subi $sp, $sp, 24
	move $t0, $a0
	sw $t0, 0($sp)
	...
	move $a2, $t2
	move $a3, $t3
	jal tailRecFactBisBisBis_integer_integer_integer_integer_integer_integer_integer
	subi $sp, $sp, -16
	sw $v0, -4($sp)
	lw $t1, -4($sp)
	lw $t0, 0($sp)
...
_label_8:
	...
	move $a3, $t6
	jr $ra
tailRecFactBis_integer_integer_integer:
	sw $fp, 0($sp)
	sw $ra, -4($sp)
tailRecFactBis_integer_integer_integer_tail_rec_begin:
	move $fp, $sp
	subi $sp, $sp, 24
	move $t0, $a0
	sw $t0, 0($sp)
	...
	sw $t5, -16($sp)
	sw $t6, -20($sp)
	jal tailRecFactBis_integer_integer_integer_tail_rec_begin
	b _label_10
_label_9:
	move $t0, $a1
	sw $t0, 0($sp)
...
_label_10:
	...
	move $a3, $t6
	jr $ra
tailRecFact_integer_integer:
	sw $fp, 0($sp)
	sw $ra, -4($sp)
tailRecFact_integer_integer_tail_rec_begin:
	move $fp, $sp
	subi $sp, $sp, 24
	move $t0, $a0
	sw $t0, 0($sp)
