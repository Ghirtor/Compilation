...
let andi_ r1 r2 i = ins "andi %s, %s, %d"  r1 r2 i
let or_  r1 r2 r3 = ins "or %s, %s, %s"   r1 r2 r3
let xor  r1 r2 r3 = ins "xor %s, %s, %s"   r1 r2 r3
let ori_  r1 r2 i = ins "or %s, %s, %d"   r1 r2 i
...
let movz r1 r2 r3 = ins "movz %s, %s, %s"     r1 r2 r3
let movn r1 r2 r3 = ins "movn %s, %s, %s"     r1 r2 r3
